...
func WithBlobsHosts(blobsHosts []string) Option {
	return func(c *Gateway) {
		c.blobsHosts = blobsHosts
	}
}
...
func (c *Gateway) directResponse(rw http.ResponseWriter, r *http.Request, info *PathInfo, t *token.Token) {
